...
public:
    CMainParams() {
        ...
        consensus.fork1Height = 35000;
        consensus.fork2Height = 200000;
        consensus.fork3Height = 300000;
        consensus.fork4Height = 385000;
        ...
        consensus.nPowTargetSpacing = 40; // 1 minute
