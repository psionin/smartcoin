...
void Shutdown()
{
    ...
    RenameThread("smartcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Smartcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/smartcoin/smartcoin>";
    const std::string URL_WEBSITE = "<https://smartcoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("smartcoin-loadblk");
