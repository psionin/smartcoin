UNIX BUILD NOTES
====================
Some notes on how to build Smartcoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile Smartcoin and the dependencies,
...
memory available when compiling Smartcoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Smartcoin Core without wallet.
...
If you want to build Smartcoin-Qt, make sure that the required packages for Qt development
...
# Configure Smartcoin Core to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Smartcoin may be compiled in
...
As mentioned above, when maintaining portability of the wallet between the standard Smartcoin Core distributions and independently built
...
with 4.8-built Smartcoin Core is needed follow the steps under "Berkeley DB" above.
